function [symmetry,best_match] = bilateral_symmetry(left_parcellation,right_parcellation,left_mask,right_mask)
% Left and right labels do not need to correspond
...
%     mat2nii(R2L_mask,'R2L_mask.nii',size(R2L_mask),32,'D:\Data\research\subcortex parcellation\results\0.9PCA mean_0thresh\ACCUMBENS\mask\ACCUMBENS_L.nii');
    ...
    [L2R_Dice,best_match] = iteration_Dice(right_intersection,L2R_intersection); % best_match is the label mapping from right parcellation to left parcellation
    symmetry = L2R_Dice;
