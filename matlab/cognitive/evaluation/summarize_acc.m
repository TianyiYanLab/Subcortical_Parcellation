...
% Input: result = load(fullfile(root,'metric=predictiveCOD\prediction',currTask,num2str(j-1),'final_result.mat'));
% Output: writetable(T,fullfile(root,'metric=predictiveCOD\evaluation','All cogTasks.csv'));
