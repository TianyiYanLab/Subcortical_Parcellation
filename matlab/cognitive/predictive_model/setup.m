% Purpose: setup.
% Input: load(fullfile(OriginalPath,cogTasks{ct},num2str(j-1),'setup.mat'));
% Output: save (param_name, '-struct', 'param');
% Dependencies: CBIG_KRR_workflow
clear
root = repo_path('results/prediction/cognition');
OriginalPath = repo_path('data/derived/krr_setups/cognition');
iterations = 100;
