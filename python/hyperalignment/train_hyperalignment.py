# Purpose: train hyperalignment.
# Input: idx_mat = loadmat(CORTEX_INDEX_MAT); lab_mat = loadmat(SCHAEFER_LABEL_MAT)
# Output: pickle.dump(payload, f, protocol=2); pickle.dump(final_obj, f, protocol=2)
...
OUT_DIR = str(REPO_ROOT / 'results/hyperalignment/models')
...
if __name__ == "__main__":
    main(parcel_start=int(1), parcel_end=None)
